...
<head>
    ...
    <style>
        ...
        table.izin{width:100%;border-collapse:collapse}
        table.izin th, table.izin td{border:2px solid #222;padding:8px;text-align:left}
        table.izin th{background:#f5f5f5}
        ...
        <div class="table-wrap">
            <table class="izin">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center text-muted" style="padding:48px">Tidak ada permohonan izin/sakit.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
